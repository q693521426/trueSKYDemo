...
string ToString(psfxParser::FillMode x)
{
	switch(x)
	{
	case psfxParser::FILL_WIREFRAME:
		return "FILL_WIREFRAME";
	case psfxParser::FILL_SOLID:
		return "FILL_SOLID";
	case psfxParser::FILL_POINT:
		return "FILL_POINT";
	default:
		return "UNKNOWN";
	}
}
string ToString(psfxParser::CullMode x)
{
	switch(x)
	{
	case psfxParser::CULL_NONE:
		return "CULL_NONE";
	case psfxParser::CULL_FRONT:
		return "CULL_FRONT";
	case psfxParser::CULL_BACK:
		return "CULL_BACK";
	default:
		return "UNKNOWN";
	}
}
string ToString(psfxParser::FilterMode x)
{
	switch(x)
	{
	case psfxParser::MIN_MAG_MIP_LINEAR:
		return "LINEAR";
	case psfxParser::MIN_MAG_MIP_POINT:
		return "POINT";
	default:
		return "UNKNOWN";
	}
...
string ToString(psfxParser::AddressMode x)
{
	switch(x)
	{
	case psfxParser::CLAMP:
		return "CLAMP";
	case psfxParser::WRAP:
		return "WRAP";
	case psfxParser::MIRROR:
		return "MIRROR";
	default:
		return "UNKNOWN";
	}
